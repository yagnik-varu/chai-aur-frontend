...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (formState.avatar) {
      ...
      console.log("Avatar file attached:", formState.avatar.name);
    }

    if (formState.coverImage) {
      formData.append("coverImage", formState.coverImage);
      console.log("Cover image file attached:", formState.coverImage.name);
    }
    try {
      const response = await axios
        .post("/api/v1/user/register", formData, {
          ...
          if (response.data.success) {
            ...
            setFormState({ username: '', email: '', fullname: '', password: '' }); // Clear form on success
            navigate('/');
          } else {
            console.log(response);
          }
        ...
        .catch(function (error) {
          ...
          if (error.response) {
            ...
            setErrorMessage("something wrong when you request");
      ...
      <>
        ...
        <div className="h-screen md:flex">
          ...
          <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form className="bg-white" onSubmit={handleSubmit} ref={formRef}>
